                                    ...
                                    <td class="border px-3 py-2 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <select wire:model="schedule.{{ $formattedDate }}"
                                                class="block w-full mt-1 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 p-2.5 text-xs text-gray-900 dark:text-white focus:border-blue-500 focus:ring-blue-500"
                                                :class="{
