    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4 hidden">
                ...
                <x-input id="nip" class="mt-1 block w-full" type="text" name="nip" value="KONTRAK"
                    autocomplete="nip" />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input id="phone" class="mt-1 block w-full" type="number" name="phone" :value="old('phone')"
                    required autocomplete="username" />
            </div>
